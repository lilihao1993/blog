 ...
 * @version 1.0
 */
package com.ldsh.blog.common.bean;
...
public class AjaxResponse<T> implements Serializable {
     ...
     * 邮箱已存在
     */
    public static final String ERROR_EMAIL_EXIST = "101";

    /**
     * 用户名已存在
     */
    public static final String ERROR_USERNAME_EXIST = "102";

    /**
     * 用户不存在
     */
    public static final String ERROR_USER_EXIST = "103";
